...
public class AddtoDealPizzainSelectedpizzaDetailsPageTest extends TestBase {
	...
	public AddtoDealPizzainSelectedpizzaDetailsPageTest() {
		super();
	}
	...
	@Test(priority=1)
	public void verifyAddtoDealPizzainSelectedpizzaDetailsPageTitleTest(){
		String AddtoDealPizzainSelectedpizzaDetailsPageTitle = addtoDealPizzainSelectedpizzaDetailsPage.verifyAddtoDealPizzainSelectedpizzaDetailsPageTitle();
		Assert.assertEquals(AddtoDealPizzainSelectedpizzaDetailsPageTitle, "Pizza Hut Oman | Pizza Delivery Near you | Order Pizza Online","Yourcart page title not matched");
	}
	 ...
	 */
	  ...
	  //testUtil.switchToFrame(); 
		  ...
		  try {
				TestUtil.takeScreenshotAtEndOfTest("addtoDealPizzainSelectedpizzaDetailsPage");
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		  yourcartsummaryDetailsPage = addtoDealPizzainSelectedpizzaDetailsPage.clickOnAddtoDealPizzaSelectedBtn(); 
	  }
